...
def test_init(time_stamp, frequency, note_name, duration):
    analysis_point = AnalysisPoint(time_stamp=time_stamp, frequency=frequency, note_name=note_name, duration=duration)
    assert analysis_point.time_stamp == time_stamp
    assert analysis_point.frequency == frequency
    assert analysis_point.note_name == note_name
    assert analysis_point.duration == duration
